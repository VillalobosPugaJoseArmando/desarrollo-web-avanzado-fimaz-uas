    ...
    <section class="p-2">
        <div class="container text-center text-md-start mt-5">
            <div class="row mt-3">
                ...
                <div class="col-md-4 col-lg-3 col-xl-4 mx-auo mb-4">
                    <h6 class="fw-bold mb4">CONTÁCTO</h6>
                    <p>
                        <i class="fa-solid fa-phone" > +52 6692657583</i>
                        <i class="fa-solid fa-envelope"> joarvipu2003@gmail.com</i>
                        <i class="fa-solid fa-school"> Facultad de Informática Mazatlán, Universidad Autonoma de Sinaloa.</i>
                    </p>
                </div>
            </div>
        </div>
