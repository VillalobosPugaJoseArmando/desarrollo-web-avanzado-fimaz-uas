            ...
            <tbody>
                ...
                <?php foreach($rows as $row): ?>
                    <tr>
                        ...
                        <th>
                            <a href="readOneTorneo.php?id=<?= $row['id'] ?>" class="btn
                            btn-primary"><span class="fa-solid fa-list-check"></span></a>
                            <a href="updateTorneo.php?id=<?= $row['id'] ?>" class="btn
                            btn-success"><span class="fa-solid fa-pen-to-square"></
                            span></a>
                            <!--Eliminar registro utilizando Ventana Modal.-->
                            <!-- Button trigger modal -->
                            <button type="button" class="btn btn-danger"
                            data-bs-toggle="modal" data-bs-target="#idModal<?= $row
                            ['id'] ?>">
                            <span class="fa-solid fa-trash"></span>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="Modal<?= $row
                                            ['id'] ?>">¿Desea eliminar el torneo?</h1>
